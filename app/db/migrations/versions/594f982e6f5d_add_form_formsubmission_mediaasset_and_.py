...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PENDING', 'PROCESSED', 'SPAM', name='formsubmissionstatus'), nullable=False),
    ...
    op.create_index('ix_form_submissions_submitted_at', 'form_submissions', ['submitted_at'], unique=False)
