...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "kind",
            sa.Enum("SINGLETON", "COLLECTION", name="editablecomponentkind"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_editable_component_definitions_key"),
        "editable_component_definitions",
        ["key"],
        unique=False,
    )
    op.create_index(
        op.f("ix_editable_component_definitions_kind"),
        "editable_component_definitions",
        ["kind"],
        unique=False,
    )
    op.create_index(
        op.f("ix_editable_component_definitions_site_id"),
        "editable_component_definitions",
        ["site_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_editable_component_definitions_site_id_kind",
        "editable_component_definitions",
        ["site_id", "kind"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["definition_id"],
            ["editable_component_definitions.id"],
        ),
        sa.ForeignKeyConstraint(
            ["site_id"],
            ["sites.id"],
    ...
    op.create_index(
        op.f("ix_content_entries_definition_id"),
        "content_entries",
        ["definition_id"],
        unique=False,
    )
    op.create_index(
        "ix_content_entries_definition_id_sort_order",
        "content_entries",
        ["definition_id", "sort_order"],
        unique=False,
    )
    op.create_index(
        "ix_content_entries_definition_id_status",
        "content_entries",
        ["definition_id", "status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_content_entries_site_id"), "content_entries", ["site_id"], unique=False
    )
    op.create_index(
        "ix_content_entries_site_id_status",
        "content_entries",
        ["site_id", "status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_content_entries_sort_order"),
        "content_entries",
        ["sort_order"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_editable_component_definitions_solution_id"),
        table_name="editable_component_definitions",
    )
    op.drop_index(
        "ix_editable_component_definitions_site_id_kind",
        table_name="editable_component_definitions",
